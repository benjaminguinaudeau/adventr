test_that("multiplication works", {
  expect_silent(read_advent(day = 1))
  expect_error(read_advent(day = 32),
  ...
  expect_error(read_advent(day = 1, cookie = ""))
  expect_error(read_advent(day = 1, cookie = "dd"), "Request was blocked, your cookie seems to be wrong.")
})
