...
This package provides two functions: 
  + `read_advent_of_code`, which directly loads into your session the problem data of a specific day of the [Advent of Code](https://adventofcode.com/).
  + `submit_to_advent_of_code`, which directly submit your solution to a specific problem
